...
def generate_info_card():
    svg_content = """<svg xmlns="http://www.w3.org/2000/svg" width="490" height="387" viewBox="0 0 490 387" font-family="ui-monospace, SFMono-Regular, Menlo, Consolas, monospace">
    <defs>
    ...
    <rect width="490" height="387" rx="12" fill="url(#bg)"/>
    ...
    <g font-size="14" fill="#c9d1d9">
        ...
        <g opacity="0"><animate attributeName="opacity" to="1" dur="0.2s" begin="0.5s" fill="freeze"/>
            <text x="30" y="115"><tspan fill="#ffbd2e" font-weight="bold">OS</tspan>: Arch Linux</text>
        </g>
        
        <g opacity="0"><animate attributeName="opacity" to="1" dur="0.2s" begin="0.7s" fill="freeze"/>
            <text x="30" y="145"><tspan fill="#ffbd2e" font-weight="bold">Host</tspan>: Eurt-labs</text>
        </g>
        
        <g opacity="0"><animate attributeName="opacity" to="1" dur="0.2s" begin="0.9s" fill="freeze"/>
            <text x="30" y="175"><tspan fill="#ffbd2e" font-weight="bold">Role</tspan>: ECE Engineer | AI/ML &amp; Security</text>
        </g>
        ...
        <g opacity="0"><animate attributeName="opacity" to="1" dur="0.2s" begin="1.3s" fill="freeze"/>
            <text x="30" y="235"><tspan fill="#ffbd2e" font-weight="bold">Learning</tspan>: AI/ML, Quantum Computing, Security</text>
        </g>

        <g opacity="0"><animate attributeName="opacity" to="1" dur="0.2s" begin="1.5s" fill="freeze"/>
            <text x="30" y="265"><tspan fill="#ffbd2e" font-weight="bold">Tech Stack</tspan>: Python, PyTorch, C++, React</text>
        </g>
        ...
        <g opacity="0"><animate attributeName="opacity" to="1" dur="0.2s" begin="1.9s" fill="freeze"/>
            <rect x="30" y="325" width="20" height="20" fill="#0d1117"/>
            <rect x="55" y="325" width="20" height="20" fill="#ff5f56"/>
            <rect x="80" y="325" width="20" height="20" fill="#27c93f"/>
            <rect x="105" y="325" width="20" height="20" fill="#ffbd2e"/>
            <rect x="130" y="325" width="20" height="20" fill="#181717"/>
            <rect x="155" y="325" width="20" height="20" fill="#c9d1d9"/>
        </g>
    </g>
</svg>"""
